...
var oui = function() {
    var isUndefined = function(o) { return typeof o === 'undefined'; },
        ...
        utils = {
            ...
            isProperty: isProperty, trim: trim, extend: extend,
    ...
    var doc = typeof document !== 'undefined' ? document : {
        ...
        isElement = function(element) {
            return isObject(element) && isNumber(element.nodeType) && isString(element.tagName);
        },
...
//Javascript 原生对象扩展
!function ($) {
    var extendCounter = 1, debug = !$.isUndefined($.getQueryString()['debug']);
    $.extend($, {
